...
export const templateSurveyQuestions = [
    ...
    // 🏘️ Q2a - Nom de rue - Lannion
    {
        id: "Q2a_Lannion",
        text: "De quelle rue venez-vous ?",
        type: 'street',
        streetFile: "lannion.json",
        next: "Q3"
    },

    // 🏘️ Q2a - Nom de rue - Ploulec'h
    {
        id: "Q2a_Ploulech",
        text: "De quelle rue venez-vous ?",
        type: 'street',
        streetFile: "ploulech.json",
        next: "Q3"
    },

    // 🏘️ Q2a - Nom de rue - Ploubezre
    {
        id: "Q2a_Ploubezre",
        text: "De quelle rue venez-vous ?",
        type: 'street',
        streetFile: "ploubezre.json",
        next: "Q3"
    },
    ...
    // 📝 Q3b - Autre lieu de dépose
    {
        id: "Q3b_Autre",
        text: "Préciser :",
        type: 'freeText',
        freeTextPlaceholder: "Préciser le lieu de dépose...",
        next: "Q4"
    },
    ...
    // 🚌 Q3c - Ligne de bus/car (si Q3 = 5)
    {
        ...
        type: 'singleChoice',
        options: [
            { id: 1, text: "Ligne Tilt A (Le Rhu / Aéroport – Hôpital Ploubezre)", next: "Q4" },
            { id: 2, text: "Ligne Tilt B (Beg Léguer – St Marc)", next: "Q4" },
            { id: 3, text: "Ligne Tilt C (Ampère – Roz ar Gavet)", next: "Q4" },
            { id: 4, text: "Ligne Tilt D (vers Trébeurden)", next: "Q4" },
            { id: 5, text: "Ligne Tilt E (vers Trégastel via Perros-Guirec)", next: "Q4" },
            { id: 6, text: "Ligne Tilt M (ligne marché)", next: "Q4" },
            { id: 7, text: "Ligne 30 (Lannion – Morlaix)", next: "Q4" },
    ...
    // 🚉 Q5 - Gare de destination finale
    {
        ...
        options: [
            ...
            { id: 2, text: "Brest", next: "Q6" },
            { id: 3, text: "Morlaix", next: "Q6" },
    ...
    // 🏘️ Q2a (Non-voyageurs) - Nom de rue - Lannion
    {
        id: "Q2a_NON_VOYAGEUR_Lannion",
        text: "De quelle rue venez-vous ?",
        type: 'street',
        streetFile: "lannion.json",
        next: "Q3_NON_VOYAGEUR"
    ...
    // 🏘️ Q2a (Non-voyageurs) - Nom de rue - Ploulec'h
    {
        id: "Q2a_NON_VOYAGEUR_Ploulech",
        text: "De quelle rue venez-vous ?",
        type: 'street',
        streetFile: "ploulech.json",
        next: "Q3_NON_VOYAGEUR"
    ...
    // 🏘️ Q2a (Non-voyageurs) - Nom de rue - Ploubezre
    {
        id: "Q2a_NON_VOYAGEUR_Ploubezre",
        text: "De quelle rue venez-vous ?",
        type: 'street',
        streetFile: "ploubezre.json",
        next: "Q3_NON_VOYAGEUR"
    ...
    // 🅿️ Q3a (Non-voyageurs) - Lieu de stationnement
    {
        ...
        image: "plan.png",
        options: [
            { id: 1, text: "Dans le parking Min Ran (gare ouest)", next: "Q4_NON_VOYAGEUR" },
            { id: 2, text: "Dans le parking Rol Tanguy (gare est)", next: "Q4_NON_VOYAGEUR" },
            { id: 3, text: "Sur une place proche du bâtiment voyageurs (durée limitée)", next: "Q4_NON_VOYAGEUR" },
            { id: 4, text: "Dans le parking Caerphilly", next: "Q4_NON_VOYAGEUR" },
            { id: 5, text: "Sur une autre place en voirie ou parking", next: "Q3a_NON_VOYAGEUR_Autre" },
            { id: 6, text: "Sur un stationnement privé (box ou place de parking privée)", next: "Q4_NON_VOYAGEUR" },
            { id: 7, text: "Sur un arceau vélo (pour les 2 roues motorisés uniquement)", next: "Q4_NON_VOYAGEUR" }
        ]
    },
