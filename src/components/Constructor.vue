...
const pageTitle = ref('LANNION'); // Browser tab title
...
const customWelcomeMessage = ref(`Bonjour,<br><br> pour mieux connaître les usagers de la gare de Lannion, Lannion-Trégor Communauté,<br><br> la Région Bretagne et la SNCF souhaiteraient en savoir plus sur votre déplacement en cours.<br><br> Auriez-vous quelques secondes à nous accorder ? `); // HTML welcome message
